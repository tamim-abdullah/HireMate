...
<head>
    ...
    <link rel="stylesheet" href="profile_sidebar.css" />
                            ...
                            <div class="card-body">
                                <form id="profile-form" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="inputJobTitle" type="text"
                                            placeholder="Enter your job title" value="<?php echo $job_title ?>">
                                    </div>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="inputLocation" type="text"
                                                placeholder="Enter your location" value="<?php echo $location ?>">
                                        </div>
                                    </div>
                                    <!-- Form Row-->
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="inputBirthday" type="text" name="birthday"
                                                placeholder="Enter your birthday" value="<?php echo $dob?>">
                                        </div>
                                    </div>
                                    <!-- Save changes button-->
